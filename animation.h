...
public:
  ...
  typedef std::map<std::string, SkelDOF> angles_t;  //骨架分支的角度映射表
public:
...
protected:
  ...
  class ActorInitializer : public Skeleton::ArcVisitor     //初始化骨架各个分支的旋转角度.
  {
  protected:
    /// Actor to process
    Actor* a_;
...
protected:
  ...
  class ActorUpdater : public Skeleton::ArcVisitor   //更新骨架分支的旋转角度
  {
  protected:
    /// Actor to process
    Actor* a_;
